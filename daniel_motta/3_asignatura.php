...
echo "Nombre de la asignatura 1: ".$asignatura1->getNombre()."<br>";
echo "Codigo de la asignatura 1: ".$asignatura1->getCodigo()."<br>";
echo "Creditos de la asignatura 1: ".$asignatura1->getCreditos()."<br>";

// $asignatura1->setNombre("Musica");
// $asignatura1->setCodigo("M201");
// $asignatura1->setCreditos(5);
