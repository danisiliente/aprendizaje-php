...
echo "Nombre del estudiante 1: ".$estudiante1->getNombre()."<br>";
echo "Apellido del estudiante 1: ".$estudiante1->getApellido()."<br>";
echo "Edad del estudiante 1: ".$estudiante1->getEdad()."<br>";

// $estudiante1->setNombre("Lily");
// $estudiante1->setApellido("Evans");
